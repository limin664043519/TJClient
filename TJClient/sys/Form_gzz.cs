...
{
    public partial class Form_gzz : sysCommonForm
    {
        ...
        {
            Form_gzzBll xmfl = new Form_gzzBll();
            string strWhere = "";
            ...
            {
                strWhere = strWhere + string.Format("  and GZZMC like '%{0}%' " , mc.Text.Trim());
            }
        ...
        private void button_del_Click(object sender, EventArgs e)
        {
          ...
          try
          {
              ...
              Form_gzzBll SjzdBll = new Form_gzzBll();
