...
{
    public partial class Form_xm : sysCommonForm
    {
        ...
        {
            Form_xmBll xmfl = new Form_xmBll();
            string strWhere = "";
            if (mc.Text.Trim().Length > 0)
            {
                strWhere = strWhere + string.Format(" and XMMC  like '%{0}%' ", mc.Text.Trim());
            }
        ...
        private void button_del_Click(object sender, EventArgs e)
        {
          ...
          try
          {
              ...
              Form_xmBll SjzdBll = new Form_xmBll();
