...
{
    public partial class Form_xmzy : sysCommonForm
    {
        ...
        {
            Form_xmzyBll xmzy = new Form_xmzyBll();
            string strWhere = "";
            if (mc.Text.Trim().Length > 0)
            {
                strWhere = strWhere + string.Format(" and t1.XMMC LIKE '%{0}%' ", mc.Text.Trim());
            }
            DataTable dt = xmzy.GetMoHuList(strWhere);
            showDataGrid(dt);
        }
        ...
        private void button_del_Click(object sender, EventArgs e)
        {
          ...
          try
          {
              ...
              Form_xmzyBll SjzdBll = new Form_xmzyBll();
