...
{
    public partial class Form_xmfl : sysCommonForm
    {
        ...
        {
            Form_xmflBll xmfl = new Form_xmflBll();
            string strWhere = "";
            if (mc.Text.Trim().Length > 0)
            {
                strWhere = strWhere + string.Format(" and XMFLMC  like '%{0}%' ", mc.Text.Trim());
            }
        ...
        private void button_del_Click(object sender, EventArgs e)
        {
          ...
          try
          {
              ...
              Form_xmflBll SjzdBll = new Form_xmflBll();
