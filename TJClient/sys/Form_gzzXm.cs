...
{
    public partial class Form_gzzXm : sysCommonForm
    {
        ...
        {
            Form_gzzXmBll xmfl = new Form_gzzXmBll();
            string strWhere = "";

            if (UserInfo.Yybm != null && UserInfo.Yybm.Trim().Length > 0)
            {
                strWhere = strWhere + string.Format(" and  T_JK_GZZ_XM.YLJGBM ='{0}' ", UserInfo.Yybm);
            }
        ...
        private void button_del_Click(object sender, EventArgs e)
        {
          ...
          try
          {
              ...
              Form_gzzXmBll SjzdBll = new Form_gzzXmBll();
