...
{
    public partial class Form_yljg : sysCommonForm
    {
        ...
        {
            Form_yljgBll xmfl = new Form_yljgBll();
            string strWhere = "";
            ...
            {
                strWhere = strWhere + string.Format(" and  XT_GG_SYDW.MC  like '%{0}%' ", mc.Text.Trim());
            }
        ...
        private void button_del_Click(object sender, EventArgs e)
        {
          ...
          try
          {
              ...
              Form_yljgBll SjzdBll = new Form_yljgBll();
