...
{
    public partial class Form_Sjzd : sysCommonForm
    {
        ...
        {
            Form_SjzdBll Sjzd = new Form_SjzdBll();
            string strWhere = "";
            if (bm.Text.Trim().Length > 0)
            {
                strWhere = strWhere + string.Format(" and ZDLXBM='{0}' ", bm.Text.Trim());
            }
            DataTable dt = Sjzd.GetMoHuList(strWhere);
            showDataGrid(dt);
        }
        ...
        private void button_del_Click(object sender, EventArgs e)
        {
          ...
          try
          {
              ...
              Form_SjzdBll SjzdBll = new Form_SjzdBll();
