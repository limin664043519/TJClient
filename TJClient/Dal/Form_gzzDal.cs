...
namespace TJClient.sys.Dal
{
    public class Form_gzzDal
    {
        ...
        {
            string sql_Sjzd = Common.Common.getSql("sql018", strWhere);
            try
            {
            ...
            try
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        {
                            sql_Sjzd = Common.Common.getSql("sql019", dt, i);
            ...
            try
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        {
                            sql_Sjzd = Common.Common.getSql("sql020", dt, i);
                            sqlList.Add(sql_Sjzd);
                        }
                    }
                }
