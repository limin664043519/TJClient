...
using System.Data.SQLite;//添加.net引用  
...
{  
    ...
    {  
        ...
        public  string ConnectionString  
        {
            ...
            get  
            {  
                string text = ConfigurationManager.AppSettings["SQLiteConnection"];
                return string.Format(text, dbfilePath);  
            }  
        }
        ...
        #region ExecuteDataSet(dbPath,commandText,paramList[])
        /// <summary>  
        /// 查询数据集  
        /// </summary>  
